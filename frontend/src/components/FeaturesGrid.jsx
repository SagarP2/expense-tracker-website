  ...
  return (
    <section aria-labelledby="features-title" className="mt-16 md:mt-24">
      <div className="text-center max-w-3xl mx-auto px-4">
        <h2 id="features-title" className="text-3xl md:text-5xl font-bold text-text tracking-tight">Everything you need</h2>
        <p className="mt-4 text-lg md:text-xl text-text-secondary">Minimal features that matter for expense tracking. No clutter, just clarity.</p>
      </div>
